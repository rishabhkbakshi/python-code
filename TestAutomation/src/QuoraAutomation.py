...
class QuoraAutomation:
    ...
    def browserInitialization(self):
        ...
        driver = webdriver.Chrome(executable_path=r"<path>/chromedriver_win32/chromedriver.exe", desired_capabilities=capabilities)
    ...
    def timeToAction(self, driver):
        try:
            ...
            driver.find_element_by_xpath("//input[@placeholder='Email']").send_keys('xxxxx')
            driver.find_element_by_xpath("//input[@placeholder='Password']").clear()
            driver.find_element_by_xpath("//input[@placeholder='Password']").send_keys('xxxxx')                          
